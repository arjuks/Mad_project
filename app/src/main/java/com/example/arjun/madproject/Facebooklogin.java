...
public class Facebooklogin extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String socialnet = getIntent().getExtras().get(LoginActivity.SOCIALNET).toString();
        final String name = getIntent().getExtras().get(LoginActivity.NAME).toString();
        TextView email = (TextView) findViewById(R.id.emailFb);
        final EditText emailVal = (EditText) findViewById(R.id.emailFbVal);

        if(socialnet.equals("twitter")) {
            email.setVisibility(View.VISIBLE);
            emailVal.setVisibility(View.VISIBLE);

            if(emailVal.getText().toString().equals("")) {
                Toast.makeText(Facebooklogin.this, "Please put your email id", Toast.LENGTH_SHORT).show();
            }
        }
        else {
            emailVal.equals("");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(genderfb.getText().toString().equals("")) {
                    Toast.makeText(Facebooklogin.this, "Please fill in the gender", Toast.LENGTH_SHORT).show();
                }
                if(bitmap == null) {
                    Toast.makeText(Facebooklogin.this, "Please select a photo", Toast.LENGTH_SHORT).show();
                }
                else {
        ...
        photofb.setOnClickListener(new View.OnClickListener() {
